...
const translations = {
    es: {
        ...
        'project-2-title': 'Planificador UDG',
        'project-2-desc': 'Herramienta para estudiantes para organizar horarios, calificar profesores y descubrir beneficios exclusivos.',
    ...
    en: {
        ...
        'project-2-title': 'Planner UDG',
        'project-2-desc': 'Tool for students to organize schedules, rate professors, and discover exclusive benefits.',
        'project-3-title': 'TecnoShop',
